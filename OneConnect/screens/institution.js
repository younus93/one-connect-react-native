    ...
    _renderPost = () => {
        ...
        return(
            <View style={{
                ...
                <Text style={{color: Colors.secondaryDark, fontSize: 16,fontWeight: '700', opacity: 0.4}}>No posts availabe</Text>
            </View>
        )
    }
    ...
    render() {
        ...
        return(
            <ScrollView style={styles.container} alwaysBounceVertical={false} bounces={false}>
                <ImageBackground style={styles.image} source={{uri: this.item.profile_pic}} blurRadius={0} imageStyle={{resizeMode: 'cover'}}>
                ...
                <View style={styles.overviewBar}>
                    <View style={styles.overviewBox}>
                        <Text style={styles.overViewTextMain}>{this.data.students_count}</Text>
                        <Text style={styles.overViewTextSecondary}>Students</Text>
                    </View>

                    <View style={styles.overviewBox}>
                        <Text style={styles.overViewTextMain}>{this.data.batches_count}</Text>
                        <Text style={styles.overViewTextSecondary} >Batches</Text>
                    </View>

                    <View style={[styles.overviewBox, {borderRightWidth: 0}]}>
                    <Text style={styles.overViewTextMain}>{this.data.courses_count}</Text>
                ...
                <View style={styles.mapContainer}>
                    ...
                    <MapView
                        ...
                        // cacheEnabled={true}
                    >
                        <Marker coordinate={{latitude: parseInt(this.latlong[0]),longitude: parseInt(this.latlong[1])}} title={"Institution"} description={"This Institute"}>
