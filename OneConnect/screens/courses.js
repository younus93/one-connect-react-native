    ...
    render() {
        ...
        return(
            <View style={styles.container}>
                ...
                <Button style={styles.button} onPress={() => this.props.navigation.navigate('Batch', {'url': this.item.batch_url})} title="Batches" color={Colors.alternative}>
                </Button>
            </View>
        )
    }
