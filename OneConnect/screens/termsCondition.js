...
export default class TermsCondition extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.props.navigation.setParams({ title: I18n.t("PrivacyPolicy") });
  }
      ...
      <View style={styles.container}>
        ...
        >
          <Text style={styles.tcP}>
            This privacy policy ("Policy") describes how Thai Beebuck Co., Ltd.
            ("Thai Beebuck", "we", "us" or "our") collects, protects and uses
            the personally identifiable information ("Personal Information") you
            ("User", "you" or "your") may provide in Thai Beebuck mobile
            application and any of its products or services (collectively,
            "Mobile Application" or "Services"). It also describes the choices
          ...
          <Text style={styles.tcP}>
            ...
            any on BeeBuck forms in the Mobile Application. When required this
            information may include your email address, name, phone number,
            address, credit card information, bank information, or other
            Personal Information. You can choose not to provide us with certain
            information, but then you may not be able to take advantage of some
            of the Mobile Application's features. Users who are uncertain about
            what information is mandatory are welcome to contact us.
          </Text>
          <Text style={styles.tcP}>
            To fulfill our commitment to respecting and protecting your privacy,
          ...
          <Text style={styles.tcL}>
            {"\u2022"}
            We will identify the purposes for which we will collect and further
            process your personal information.
          </Text>
          <Text style={styles.tcL}>
            {"\u2022"}
            We will only collect information that is necessary to carry out the
            identified purposes of use.
          </Text>
          <Text style={styles.tcL}>
            {"\u2022"}
            We will use or disclose your personal information only for the
            purposes for which it has been collected, except with your consent,
            or as required or permitted by applicable law, and we will retain
            your information only as long as necessary to fulfill those
            purposes.
          </Text>
          <Text style={styles.tcL}>
            {"\u2022"}
          ...
          <Text style={styles.tcL}>
            {"\u2022"}
            We will implement appropriate technical and organizational measures
          ...
          <Text style={styles.tcL}>
            {"\u2022"}
            You will have access to your personal information and will be able
            to correct your personal information as appropriate in accordance
            with your rights under applicable law.
          </Text>
          <Text style={styles.tcL}>
            {"\u2022"}
            We will be accountable to you. We are interested in hearing your
            opinion regarding our compliance with these principles, this Privacy
          ...
          <Text style={styles.tcP}>
            ...
            Information in its control and custody.To fulfill our commitment to
            respecting and protecting your privacy and the confidentiality of
            your personal information, Thai Beebuck has implemented appropriate
            technical and organizational security standards, including
            industry-standard safeguards to prevent unauthorized access or
            disclosure, misuse, alternation, or destruction of your information.
            Specifically, we received ISO/IEC 27001 certification in 2007, and
            SOC2, SOC3 (SysTrust) certifications for the Beebuck App. However,
            ...
            tampered with in transit by a third-party, despite reasonable
            efforts. To help protect your privacy and confidentiality of your
            personal information, we also need your help. Please do not share
            your password with others, or use the same passwords you use for
            other services. Also, please notify us in the event you suspect any
            unauthorized use of your Account or any other breach of security via
            our Contact Form .
          </Text>
          <Text style={styles.tcP}>Privacy of children</Text>
          <Text style={styles.tcP}>
            We understand the special necessity to protect Children's on Beebuck
            privacy, and we do not knowingly collect any Personal Information
            from children under the age of 13 (under the age of 16 in Europe).
            If you are under the age of 13, please do not submit any Personal
            Information through our Mobile Application or Service. We encourage
            ...
            never to provide Personal Information through our Mobile Application
            ...
            to us through our Mobile Application or Service, please contact us.
            You must also be old enough to consent to the processing of your
            personal data in your country (in some countries we may allow your
            parent or guardian to do so on your behalf).If we learn that we have
            inadvertently collected personal information from Children, we will
            deactivate the relevant Account(s) and will take reasonable measures
            to promptly delete such personal information from our records.
          </Text>
          ...
          <Text style={styles.tcP}>
            ...
            otherwise required by law. When we do, we will post a notice in the
            Mobile Application and send you an email.
          </Text>
          ...
          <Text style={styles.tcP}>
            ...
            updated version of this Policy in the Mobile Application. When we do
            we will post a notification in our Mobile Application. Continued use
            of the Mobile Application after any such changes shall constitute
            valid and irrovocableconsent to such changes.
          </Text>
          <Text style={styles.tcP}>Acceptance of this policy</Text>
          <Text style={styles.tcP}>
            You acknowledge that you have read this Policy and agree to all its
            terms and conditions. By using the Mobile Application or its
            Services you agree to be bound by this Policy. If you do not agree
            to abide by the terms of this Policy, you are not authorized to use
            or access the Mobile Application and its Services. Contacting us If
            you have any questions about this Policy, please contact us. This
            document was last updated on August 7, 2019
          </Text>
        </ScrollView>
      </View>
    );
