        ...
        <ScrollView alwaysBounceVertical={false} bounces={false}>
          <View style={styles.banner}>
            <Image
              style={styles.image}
              source={{
                uri: this.item.institution
                  ? this.item.institution.profile_pic
                  : null
              }}
              resizeMode="cover"
            ...
            <View style={styles.bio}>
              <Text style={styles.bannerText}>
                {this.item.institution ? this.item.institution.name : "None"}
              </Text>
            ...
            <View style={styles.tabs}>
              <Button
                onPress={() =>
                  this.props.navigation.navigate("BatchMates", {
                    item: this.item.batchmates
                  })
                }
                style={{ justifyContent: "center", alignItems: "center" }}
              >
                <Text style={[styles.bannerText, { fontSize: 16 }]}>
                  {this.item.batchmates_count}
                </Text>
                <Text style={[styles.bannerText, { fontSize: 16 }]}>
              ...
              <View style={{ justifyContent: "center", alignItems: "center" }}>
                <Text style={[styles.bannerText, { fontSize: 16 }]}>
                  {this.item.batch_reminders_count}
                </Text>
                <Text style={[styles.bannerText, { fontSize: 16 }]}>
                  {I18n.t("Posts")}
                </Text>
